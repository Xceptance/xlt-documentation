...
[browser configuration and handling chapter]({{< relref "browser" >}}).
...
described [here]({{< relref "browser#set-up-a-specific-browser-executable" >}}).
...
the [Neodymium configuration properties]({{< relref "neodymium-properties#browser-behavior" >}}).
...
This
setting can be configured via the [Neodymium configuration properties]({{< relref "neodymium-properties#browser-behavior" >}}).
