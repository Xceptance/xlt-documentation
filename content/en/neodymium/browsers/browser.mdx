...
description: "Everything about browser configuration, handling and multi browser.\n"
sidebar:
  order: 10
---
...
the [Neodymium configuration properties](/neodymium/configuration/neodymium-properties/) page.
...
![Multi browser test execution.](/images/neodymium/eclipse_multibrowser_junit_view.png)
