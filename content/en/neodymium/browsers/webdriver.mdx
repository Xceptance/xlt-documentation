...
description: "Everything about WebDrivers.\n"
sidebar:
  order: 1
---
...
[browser configuration and handling chapter](/neodymium/browsers/browser/).
...
described [here](/neodymium/browsers/browser/#set-up-a-specific-browser-executable).
...
the [Neodymium configuration properties](/neodymium/configuration/neodymium-properties/#browser-behavior).
...
This
setting can be configured via the [Neodymium configuration properties](/neodymium/configuration/neodymium-properties/#browser-behavior).
