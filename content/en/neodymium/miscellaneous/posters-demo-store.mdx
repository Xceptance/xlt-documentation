...
description: "A demo store for testing developed by Xceptance\n"
sidebar:
  order: 400
---
...
![A look at the homepage for the Posters Demo Store, as it appears in its current version.](/images/neodymium/posters.png)
