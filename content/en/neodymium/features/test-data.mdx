...
description: "Everything about test data handling.\n"
sidebar:
  order: 20
---
...
![Test data location example in Eclipse.](/images/neodymium/eclipse_testdata_example.png)
...
* **@DataSet**: Can be annotated to a method and/or class. This annotation can be used to limit a method to certain data
  ...
  (index) or by using a string (id)
    ...
    * id: `@DataSet(id = "Jebediah's data set")` a string value that refers to a data set which has the same value for
      the attribute `testId` (see [Example 1](#example1) ). This allows you to name your data sets, which is useful for identification.
...
![Execution results of `MyTest` from _Example 1_.](/images/neodymium/eclipse_junit_view_example_1.png)
...
![Execution results of `MyTest` from _Example 2_.](/images/neodymium/eclipse_junit_view_example_2.png)
