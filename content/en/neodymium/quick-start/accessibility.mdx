---
title: Accessibility
description: "Integrate Google Lighthouse for accessibility and performance testing.\n"
sidebar:
  label: Accessibility
  order: 90
---
...
![The Lighthouse report inside the Allure report.](/images/neodymium/lighthouse_report.png)
