---
title: Localization
description: "Reuse test code across multiple locales and websites.\n"
sidebar:
  label: Localization
  order: 60
---
...
The `TestDataTest` from the [Data Driven](/neodymium/quick-start/data-driven/) section can be extended. For this small example, only one label on the homepage and the heading on the product listing page are localized.
...
![Report of the data driven test `TestDataTest` with localization.](/images/neodymium/localized_report.png)
