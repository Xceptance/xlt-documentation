---
title: Data Driven
description: "Separate test logic from test data using multiple formats.\n"
sidebar:
  label: Data Driven
  order: 50
---
...
Neodymium automatically runs tests for each data set defined in your data file. This can be controlled by using `@SuppressDataSets` and `@DataSet()`. More information can be found in the [Test Data](/neodymium/features/test-data/) chapter.
...
![Report of the data driven test `TestDataTest` with two data sets.](/images/neodymium/test_data_report.png)
