---
title: Multibrowser
description: "Configure and run tests across multiple browsers and devices.\n"
sidebar:
  label: Multibrowser
  order: 70
---
...
For a complete list of properties, see the [Configurations](/neodymium/browsers/browser/) page.
...
![Multibrowser report.](/images/neodymium/multibrowser_report.png)
*Multibrowser report.*
