---
title: Configuration
description: "Overview of key configuration files and properties in Neodymium.\n"
sidebar:
  label: Configuration
  order: 80
---
...
:::note
**Note:** This is a quick summary. For the complete list of all properties and detailed explanations, please visit the [Configuration](/neodymium/configuration/neodymium-properties/) page. For browser-specific configurations, see [Browsers](/neodymium/browsers/browser/).
:::
