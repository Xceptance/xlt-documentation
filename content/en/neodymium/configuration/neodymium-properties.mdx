...
description: "Everything you can configure in the Neodymium properties.\n"
sidebar:
  order: 90
---
...
| neodymium.lighthouse.assert.audits                       | &lt;none&gt;  | A comma separated list of audits to assert. If one fails, the test also fails. A full list of all audit ID's and their corresponding titles can be found [here](/neodymium/features/accessibility/#lighthouse-audit-validation).                                                               |
...
The browser properties can be found in the [Browsers](/neodymium/browsers/browser/) section.
