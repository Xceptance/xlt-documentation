...
description: "Logging in Neodymium using SLF4J\n"
sidebar:
  order: 120
---
...
* All [test data](/neodymium/features/test-data/).
* The currently used [WebDriver](/neodymium/browsers/webdriver/) instance.
* [Localization data](/neodymium/features/localization/).
* An instance of
...
See the [test data chapter](/neodymium/features/test-data/) for more information and convenience methods related to test
data.

### Localization

The `Neodymium` class offers access to the [Localization](/neodymium/features/localization/) feature:
...
the [NeodymiumConfiguration](/neodymium/configuration/neodymium-properties/)
