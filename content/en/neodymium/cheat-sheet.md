...
Further read: [Neodymium properties]({{< relref "configuration/neodymium-properties.md" >}})
...
See [Parallel Execution]({{< relref "framework/parallel-execution.md" >}}).
...
The [Page Object Model (POM)]({{< relref "framework/page-objects.md" >}}) wraps all elements and functionality of a
