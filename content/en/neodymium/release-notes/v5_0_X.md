...
* Improvement: [Filter test execution](https://github.com/Xceptance/neodymium/wiki/Neodymium-configuration-properties#Testfiltering-configuration)
  * Now it is possible to use regex for class name, method name and data set id to filter testcase execution
* Improvement: Configure standard [download folder](https://github.com/Xceptance/neodymium/wiki/Multi-browser-support#Browser-profile-configuration)
  * Only for Chrome & Firefox
* Improvement: [Locale Check](https://github.com/Xceptance/neodymium/wiki/Neodymium-context#Locale)
  * checks for given locale matching a given list similar to Neodymium.isSite(String... sites)

* Improvement: [@WIP- Annotation](/neodymium/features/wip-annotation/)
  * You are able to run a single test, a nice way while implementing new stuff  
* Improvement: [@RandomDataSet annotation](https://github.com/Xceptance/neodymium/wiki/Test-data-provider#Data-sets)
  * Allows to run tests with certain amount of random data sets, given from defined test data list
* Improvement: [@DataItem annotation](https://github.com/Xceptance/neodymium/wiki/Test-data-provider#Data-item)  
  * Used to instantiate object with values stemming from test data
* Improvement: [Waiting functions](https://github.com/Xceptance/neodymium/wiki/Utility-classes#Example5-optionalWaitConditions) optionalWaitUntilCondition & optionalWaitWhileCondition
...
* Improvement: Logging with Log4j as standard removed
  * If you want to use Logging, you can now integrate every library you want to use. For further Information look up how to setup [here](https://github.com/Xceptance/neodymium/wiki/Logging)  
...
Since this a big update with several major changes we created an article about the necessary steps to migrate to Neodymium version 5 [here](/neodymium/miscellaneous/migrate-to-v5/)
