---
title: Cheat Sheet
description: "Quick reference for all Neodymium features and how to use them on
  a single page.\n"
sidebar:
  order: 20
---
...
Further read: [Neodymium properties](/neodymium/configuration/neodymium-properties/)
...
See [Parallel Execution](/neodymium/framework/parallel-execution/).
...
The [Page Object Model (POM)](/neodymium/framework/page-objects/) wraps all elements and functionality of a
