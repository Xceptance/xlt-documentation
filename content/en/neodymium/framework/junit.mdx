---
title: JUnit
description: "A comprehensive guide to mastering Neodymium's powerful extensions
  for JUnit, covering key features like annotations, test multiplication, and
  test suites.\n"
sidebar:
  order: 80
---
...
Please check the [browser](/neodymium/browsers/browser/) page for detailed information.
...
Please check the [test data](/neodymium/features/test-data/) page for detailed information.
