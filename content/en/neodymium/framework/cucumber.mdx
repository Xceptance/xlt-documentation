---
title: Cucumber
description: "Everything about BDD in Neodymium using Cucumber.\n"
sidebar:
  order: 200
---

[Cucumber](https://github.com/cucumber/cucumber) is a Behavior-Driven Development (BDD) framework. Currently, the Cucumber framework is supported in combination with JUnit4 only. Please follow these [instructions](/neodymium/miscellaneous/migrate-to-v5/) to migrate or set up your Cucumber project with Neodymium 5.
