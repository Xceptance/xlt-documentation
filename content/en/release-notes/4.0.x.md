...
![](/images/user-manual/ScriptDev_MainWindow-small.png):/images/user-manual/ScriptDev\_MainWindow.png
<span class="caption">XLT Script Developer</span>
...
`mastercontroller.sh -auto -report -testPropertiesFile`
loadtest\_1000users.properties
...
-Dcom.xceptance.xlt.mastercontroller.testSuitePath=samples/testsuite-pebble  
./mastercontroller.sh -auto
-Dcom.xceptance.xlt.mastercontroller.testSuitePath=samples/testsuite-showcases
