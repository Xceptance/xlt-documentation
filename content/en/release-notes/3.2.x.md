...
`com.xceptance.xlt.reportgenerator.requestMergeRules.0.newName =`
{n:1} CSS  
...
bc(ini).. com.xceptance.xlt.reportgenerator.requestMergeRules.0.newName
= {n:1} - {u:1}  
com.xceptance.xlt.reportgenerator.requestMergeRules.0.namePattern =
(\[^.\]+)  
com.xceptance.xlt.reportgenerator.requestMergeRules.0.contentTypePattern
...
com.xceptance.xlt.reportgenerator.requestMergeRules.0.urlPattern =
^(http\[s\]\*)://  
com.xceptance.xlt.reportgenerator.requestMergeRules.0.stopOnMatch =
false

com.xceptance.xlt.reportgenerator.requestMergeRules.1.newName = {n:1} -
{s:1}  
...
`\#\# The user agent string that will be sent to the server. By`
default, the user

\#\# agent string is derived from the configured browser, but can be
overridden
...
com.xceptance.xlt.browser.userAgent = Test User-Agent sent by Xceptance
LoadTest
...
`com.xceptance.xlt.proxy.bypassForHosts = localhost`
127\\\\.0\\\\.0\\\\.1 ^192\\\\.168
...
![](/images/releasenotes/agents-gc-and-cpu-information-small.jpg):/images/releasenotes/agents-gc-and-cpu-information-large.png
<span class="caption">The agent CPU and GC overview table</span>

![](/images/releasenotes/agent-cpu-usage-chart-small.jpg):/images/releasenotes/agent-cpu-usage-chart-large.png
<span class="caption">The CPU usage chart for an agent</span>
...
![](/images/releasenotes/new-test-report-design-small.jpg):/images/releasenotes/new-test-report-design-large.jpg
<span class="caption">A screenshot of the new report layout</span>
...
![](/images/releasenotes/new-result-browser-overview-small.jpg):/images/releasenotes/new-result-browser-overview-large.jpg
<span class="caption">The new result browser interface</span>
...
![](/images/releasenotes/events-on-console-small.jpg):/images/releasenotes/events-on-console-large.png
<span class="caption">Events on the console output</span>
...
![](/images/releasenotes/new-concurrent-user-chart-in-transaction-small.jpg):/images/releasenotes/new-concurrent-user-chart-in-transaction-large.png
<span class="caption">The new concurrent user chart</span>
...
![](/images/releasenotes/new-time-format-settings-small.jpg):/images/releasenotes/new-time-format-settings-large.png
<span class="caption">Time formatting in reports</span>
...
bc(cmd). create\_report.cmd ..\\results\\20090212-153406  
