...
{{< figure src="/images/releasenotes/agents-gc-and-cpu-information-small.jpg" link="/images/releasenotes/agents-gc-and-cpu-information-large.png" target="\_blank" caption="The agent CPU and GC overview table" >}}

{{< figure src="/images/releasenotes/agent-cpu-usage-chart-small.jpg" link="/images/releasenotes/agent-cpu-usage-chart-large.png" target="\_blank" caption="The CPU usage chart for an agent" >}}
