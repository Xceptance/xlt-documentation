...
{{< image src="releasenotes/4.10.3/report_project_name.png" large="releasenotes/4.10.3/report_project_name.png" >}}
...
{{< image src="releasenotes/4.10.0/report_apdex.png" large="releasenotes/4.10.0/report_apdex.png" >}}
Apdex for actions
{{< /image >}}
...
{{< image src="releasenotes/4.10.0/report_request_table_colorization.png" large="releasenotes/4.10.0/report_request_table_colorization.png" >}}
...
{{< image src="releasenotes/4.10.0/report_max_cpu.png" large="releasenotes/4.10.0/report_max_cpu.png" >}}
