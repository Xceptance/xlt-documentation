...
`com.xceptance.xlt.ssl.protocols = SSLv3, TLSv1, TLSv1.1,`
TLSv1.2
...
`cd <xlt>/bin  `
create\_scriptdoc.sh <path_to_testsuite>
...
![Load Testing Dashboard](/images/releasenotes/xlt450/realtime-reporting.png "Load Testing Dashboard")
...
![New Chart](/images/releasenotes/xlt450/new_chart.png "New Chart")
...
bc(bash). create\_report -from 20141210-140000 -to 20141210-150000 …
...
bc(bash). create\_report -from +15m -to –10m …
...
bc(bash). create\_report -from 20141210-140000 -l 1h …  
create\_report -from +15m -l 1h …
...
bc(bash). ec2\_admin.sh run eu-central-1 c3.2xlarge ami-de5dcdb6 5
Posters -o agents.properties  
mastercontroller.sh -auto -report -pf agents.properties  
ec2\_admin.sh terminate eu-central-1 Posters
...
`com.xceptance.xlt.mastercontroller.initialResponseTimeout =`
60000
