...
Center](https://lab.xceptance.de/versions/46).
...
overview of changes and the latest roadmap at the [XLT Information
Center](https://lab.xceptance.de/versions/45).
...
overview of changes and the latest roadmap at the [XLT Information
Center](https://lab.xceptance.de/versions/41).
...
overview of changes and the latest roadmap at the [XLT Information
Center](https://lab.xceptance.de/versions/40).
...
overview of changes and the latest roadmap at the [XLT Information
Center](https://lab.xceptance.de/versions/39).
...
overview of changes and the latest roadmap at the [XLT Information
Center](https://lab.xceptance.de/versions/38).
...
The [class path wildcard
feature](http://download.oracle.com/javase/6/docs/technotes/tools/windows/classpath.html)
...
overview of changes and the latest roadmap at the [XLT Information
Center](https://lab.xceptance.de/versions/37).
...
overview of changes and the latest roadmap at the [XLT Information
Center](https://lab.xceptance.de/versions/36).
...
bc(ini).. +—~~500u——————————~~  
\|  
<span class="underline">—–400u——</span>  
\|  
<span class="underline">—–300u——</span>  
\|  
<span class="underline">—–200u——</span>  
\|  
<span class="underline">—–100u——</span>  
\|  
-<span class="underline">—\<10min\>—</span>—\<10min\>—<span
class="underline">—\<10min\>—</span>—\<10min\>—<span
...
Information Center](https://lab.xceptance.de/versions/27).
...
.+  
com.xceptance.xlt.reportgenerator.requestMergeRules.0.runTimeRanges =
100, 300, 500, 1000
...
`\#\# Whether or not the compilation and execution time of`
JavaScript snippets
...
`\#\# Whether the framework should abort a transaction (defaults`
to false)

\#\# if it exceeds a certain maximum run time \[ms\] (defaults to 15
min).  
...
`\#\# The directory where the separate agent directories are`
located.

\#\# Defaults to: <XLT_HOME>/agent  
com.xceptance.xlt.agentcontroller.agentsdir = /my\_agents\_dir
...
\#\# - resync … re-synchronize asynchronous AJAX calls calling from the
main thread
