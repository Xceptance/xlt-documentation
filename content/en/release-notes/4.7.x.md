...
bc(plain).
com.xceptance.xlt.mastercontroller.agentcontrollers.ac001\_ap-southeast-2.url
= https://52.62.14.48:8500  
com.xceptance.xlt.mastercontroller.agentcontrollers.ac002\_us-east-1.url
= https://54.82.197.127:8500
...
![Script test case with post-steps](/images/user-manual/ScriptDev_PostSteps.png "Script test case with post-steps")
...
![Manage data sets in Script Developer](/images/user-manual/ScriptDev_EditDataSets.png "Manage data sets in Script Developer")

![Data-driven tests in Script Developer](/images/user-manual/ScriptDev_DataDrivenTest.png "Data-driven tests in Script Developer")
...
`com.xceptance.xlt.loadtests.default.loadFactor = 15m/1, 60m/1,`
65m/2, 120m/1.5  
...
`create\_report.sh ../results/20160405-174602 -i`
“TBrowse,TOrder”  
create\_report.sh ../results/20160405-174602 -e “TBrowse,T.\*?Order”
...
![Custom Values](/images/releasenotes/4.7.0/report_custom_values.png "Custom Values")
...
![Request Errors](/images/releasenotes/4.7.0/report_request_errors.png "Request Errors")

![Transaction Errors](/images/releasenotes/4.7.0/report_transaction_errors.png "Transaction Errors")
...
bc(ini).
com.xceptance.xlt.reportgenerator.errors.requestErrorOverviewChartsLimit
= 0  
com.xceptance.xlt.reportgenerator.errors.transactionErrorOverviewChartsLimit
= –1  
com.xceptance.xlt.reportgenerator.errors.transactionErrorDetailChartsLimit
= 10
...
![DNS timings](/images/releasenotes/4.7.0/report_dns_timings.png "DNS timings")
...
bc(ini).
com.xceptance.xlt.results.data.request.collectAdditionalRequestInfo =
true
...
![How to create a certificate](/images/releasenotes/4.7.0/proxyrec_cert.png "How to create a certificate")
