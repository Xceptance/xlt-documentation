...
don’t forget to visit our new **<a href="https://ask.xceptance.de" target="_blank">XLT Community Forum</a>** to ask questions or discuss things
with other users.
...
<a href="https://www.microsoft.com/en-us/download/details.aspx?id=48212" target="_blank">Microsoft</a>.
...
See the [User Manual](../../load-testing/manual/550-report-configuration/#adjusting-the-charting) for more
information.
...
See the [User Manual](../../load-testing/manual/550-report-configuration) for more
...
scripts ready to be run by the <a href="https://github.com/Xceptance/testsuite-nocoding" target="_blank">NoCoding test suite</a> to replay the
