...
![Conditional Module Calls](/images/releasenotes/4.6.0/sd_conditional_module_calls.png "Conditional Module Calls")

> Please remember that all *${…}* and
> \_`{...}_ expressions will simply be replaced with their textual value when evaluating the condition. So make sure to quote them properly, or otherwise the resulting Javascript expression will be invalid. As a rule of thumb, everything you can put into the target field of an `assertEval@
...
`xlt.webDriver = chrome\_clientperformance`
...
![Request Filters in Action](/images/releasenotes/4.6.0/resultbrowser_filters.png "Request Filters in Action")
...
`Session.startAction(String)` method which replaces the already existing
- and now deprecated - method `Session.setWebDriverActionName(String)`.
...
`xlt.webDriver = edge  `
xlt.webDriver.edge.pathToDriverServer =
...
![Text Filters](/images/releasenotes/4.6.0/report_filters.png "Text Filters")
...
![Percentiles](/images/releasenotes/4.6.0/report_percentiles.png "Percentiles")
...
`com.xceptance.xlt.reportgenerator.runtimePercentiles = 50, 95,`
99, 99.9
...
![Precomputed External Data](/images/releasenotes/4.6.0/report_precomputed_data.png "Precomputed External Data")
...
AMI : ami-93b1afff - Xceptance XLT 4.6.0 - BETA - 2016/01/14, Java 8,
Ubuntu 14.04, 64bit, IPv6, CP  
Region : eu-central-1  
...
![How to create and use AWS credentials](/images/releasenotes/4.6.0/jenkins_aws_creds.png "How to create and use AWS credentials")
