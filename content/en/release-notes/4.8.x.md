...
<kbd>\|\></kbd> or the keyboard shortcut <kbd>Alt</kbd>+<kbd>F5</kbd>.
...
`com.xceptance.xlt.reportgenerator.maskPropertiesRegex =`
(?i)(password\|passphrase\|login)
...
bc(java). public XltFirefoxDriver(FirefoxBinary binary, FirefoxProfile
...
![XLT Test Automation Survey](/images/releasenotes/4.8.1/survey.png "XLT Test Automation Survey")
...
![Value Log in the Result Browser](/images/releasenotes/4.8.0/resultbrowser_value_log.png "Value Log in the Result Browser")
...
bc(java). Map\<String, Object\> valueLog =
Session.getCurrent().getValueLog();  
...
bc(note). This feature had already been implemented selectively for
...
TOrder\_DE.com.xceptance.xlt.thinktime.action = 10000  
...
for *TOrder\_DE* and 0ms for *TRestApi*.
...
\|com.xceptance.xlt.browser.userAgent\|\<derived from the browser
type&gt;\|  
...
\|*. Web Driver Settings\|*. \|  
\|xlt.webDriver\|xlt\|  
{color:\#888}.\|xlt.webDriver.\<type&gt;.pathToDriverServer\|\<use PATH
environment variable&gt;\|  
\|xlt.webDriver.\<type&gt;.pathToBrowser\|\<use PATH environment
variable&gt;\|  
