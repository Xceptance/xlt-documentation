...
{{< image src="releasenotes/4.8.1/survey.png" large="releasenotes/4.8.1/survey.png" >}}
XLT Test Automation Survey
{{< /image >}}
...
Since geckodriver is [not complete
...
your Firefox to version 47.0.1 or, even better, use the [Extended
Support Release](https://www.mozilla.org/en-US/firefox/organizations/)
...
{{< image src="releasenotes/4.8.0/resultbrowser_value_log.png" large="releasenotes/4.8.0/resultbrowser_value_log.png" >}}
...
their default value. Properties in {{< grey >}}gray{{< /grey >}}
...
|{{< grey >}}com.xceptance.xlt.http.requestId.enabled{{< /grey >}}|{{< grey >}}false{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.http.requestId.headerName{{< /grey >}}|{{< grey >}}X-XLT-RequestId{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.http.requestId.length{{< /grey >}}|{{< grey >}}15{{< /grey >}}|  
...
|{{< grey >}}com.xceptance.xlt.js.cache.size{{< /grey >}}|{{< grey >}}100{{< /grey >}}|  
...
|{{< grey >}}com.xceptance.xlt.css.cache.size{{< /grey >}}|{{< grey >}}100{{< /grey >}}|  
|com.xceptance.xlt.css.download.images|never|  
| **Test Data Management Settings** | |  
|{{< grey >}} com.xceptance.xlt.data.directory{{< /grey >}}|{{< grey >}}./config/data{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.data.dataSets.dir{{< /grey >}}|{{< grey >}}&lt;ignored&gt;{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.data.dataSetProviders.\<extension\>{{< /grey >}}|{{< grey >}}&lt;ignored&gt;{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.data.dataDrivenTests.enabled{{< /grey >}}|{{< grey >}}true{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.data.dataSetProviders.csv.encoding{{< /grey >}}|{{< grey >}}UTF-8{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.data.dataSetProviders.csv.separator{{< /grey >}}|{{< grey >}},{{< /grey >}}|  
| **Result Settings** | |  
...
|{{< grey >}}com.xceptance.xlt.result-dir{{< /grey >}}|{{< grey >}}./results{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.results.data.request.collectAdditionalRequestInfo{{< /grey >}}|{{< grey >}}false{{< /grey >}}| 
| **Test Execution Settings** | |  
|com.xceptance.xlt.thinktime.action|0|  
|com.xceptance.xlt.thinktime.action.deviation|0|  
|{{< grey >}}com.xceptance.xlt.thinktime.transaction{{< /grey >}}|{{< grey >}}0{{< /grey >}}| 
|{{< grey >}}com.xceptance.xlt.thinktime.transaction.deviation{{< /grey >}}|{{< grey >}}0{{< /grey >}}|
|{{< grey >}}com.xceptance.xlt.random.initValue{{< /grey >}}|{{< grey >}}&lt;timestamp&gt;{{< /grey >}}| 
...
|{{< grey >}}com.xceptance.xlt.abortLongRunningTransactions{{< /grey >}}|{{< grey >}}false{{< /grey >}}| 
|com.xceptance.xlt.maximumTransactionRunTime|900000|  
|{{< grey >}}com.xceptance.xlt.hangingUsersGracePeriod{{< /grey >}}|{{< grey >}}30000{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.maxErrors{{< /grey >}}|{{< grey >}}1000{{< /grey >}}|  
| **Web Driver Settings** | |  
|xlt.webDriver|xlt|  
|{{< grey >}}xlt.webDriver.&lt;type&gt;.pathToDriverServer{{< /grey >}}|{{< grey >}}&lt;use PATH environment variable&gt;{{< /grey >}}|  
...
|{{< grey >}}xlt.webDriver.&lt;type&gt;.screenless{{< /grey >}}|{{< grey >}}false{{< /grey >}}|  
...
|{{< grey >}}xlt.reporting.enabled{{< /grey >}}|{{< grey >}}false{{< /grey >}}|  
|{{< grey >}}xlt.reporting.interval{{< /grey >}}|{{< grey >}}5{{< /grey >}}|  
|{{< grey >}}xlt.reporting.metricNamePrefix{{< /grey >}}|{{< grey >}}&lt;empty&gt;{{< /grey >}}|  
|{{< grey >}}xlt.reporting.graphite.host{{< /grey >}}|{{< grey >}}localhost{{< /grey >}}|  
|{{< grey >}}xlt.reporting.graphite.port{{< /grey >}}|{{< grey >}}2003{{< /grey >}}|  
|*. Miscellaneous Settings|*. |  
|{{< grey >}}com.xceptance.xlt.useMasterControllerTime{{< /grey >}}|{{< grey >}}false{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.api.validators.XHTMLValidator.enabled{{< /grey >}}|{{< grey >}}true{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.xpath.engine{{< /grey >}}|{{< grey >}}jaxen{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.agent.monitoring.samplingInterval{{< /grey >}}|{{< grey >}}10000{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.useHighPrecisionTimer{{< /grey >}}|{{< grey >}}true{{< /grey >}}|  
|{{< grey >}}com.xceptance.xlt.socket.collectNetworkData{{< /grey >}}|{{< grey >}}true{{< /grey >}}|
