---
title: Maven
description: "Learn how to build and run XLT test suites using Maven.\n"
sidebar:
  order: 200
---
...
If you run a load test for your Maven test suite in [**XTC**](/xtc/loadtesting/load-project-configuration/#build), the following build steps will be executed:
