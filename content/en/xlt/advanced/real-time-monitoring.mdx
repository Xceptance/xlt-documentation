...
description: "Learn how to watch performance data instantly in your Graphite instance.\n"
sidebar:
  order: 100
---

While a load test is running, the master controller shows only basic information about the load test status. In interactive mode, you can at least download [intermediate results](/xlt/manual/test-evaluation/#intermediate-results) and generate a report to see how the test is progressing. In automated environments, however, you would have to wait until the test run finishes before you can do so.
