---
title: Gradle
description: "Learn how to build and run XLT test suites using Gradle.\n"
sidebar:
  order: 210
---
...
## Gradle Build Steps
If you run a load test for your Gradle test suite in [**XTC**](/xtc/loadtesting/load-project-configuration/#build), the following build steps will be executed:
