---
title: Glossary
description: "An explanation of the most important terms and abbreviations used in XLT.\n"
sidebar:
  label: Glossary
  order: 200
---
...
featuring a broad range of additional functionality, but it was [discontinued](/xlt/about/history/#2017---script-developer-discontinued) when Mozilla removed the XUL application API from Firefox.
