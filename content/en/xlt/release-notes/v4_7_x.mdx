...
![Script test case with post-steps](/images/user-manual/ScriptDev_PostSteps.png)
...
![Manage data sets in Script Developer](/images/user-manual/ScriptDev_EditDataSets.png)
*Manage data sets in Script Developer*

![Data-driven tests in Script Developer](/images/user-manual/ScriptDev_DataDrivenTest.png)
...
![Custom Values](/images/releasenotes/4.7.0/report_custom_values.png)
*Custom Values*
...
![Transaction Errors](/images/releasenotes/4.7.0/report_transaction_errors.png)
*Transaction Errors*
...
![DNS timings](/images/releasenotes/4.7.0/report_dns_timings.png)
*DNS timings*
...
![How to create a certificate](/images/releasenotes/4.7.0/proxyrec_cert.png)
