...
![Number of table entries](/images/releasenotes/4.9.0/report_number_of_table_entries.png)
...
![Footer row values also when filtering](/images/releasenotes/4.9.0/report_summary_row_when_filtering.png)
