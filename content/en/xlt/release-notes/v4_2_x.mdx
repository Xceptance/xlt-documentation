...
{/*  TODO: }add command reference to doc and link it here  */}}
...
For more information see the [load test section](/xlt/manual/load-configuration/#variable-load-profile) in the user manual.
