...
tool, see [Success Criteria Validation](/xlt/advanced/jenkins/#success-criteria-evaluation) in the *Advanced* section
of the user manual.
...
Please see the [Jenkins Documentation](/xlt/advanced/jenkins/#pipelines) for all the details on this result object.
...
![Create a comparison report](/images/releasenotes/4.11.0/jenkins_comparison_report.png)
