...
tool, see [Success Criteria Validation]({{< relref "ci-cd#success-criteria-evaluation" >}}) in the *Advanced* section
of the user manual.
...
Please see the [Jenkins Documentation]({{< relref "ci-cd#pipelines" >}}) for all the details on this result object.
