...
tool, see [Success Criteria Validation]({{< relref "xlt/advanced/jenkins#success-criteria-evaluation" >}}) in the *Advanced* section
of the user manual.
...
Please see the [Jenkins Documentation]({{< relref "xlt/advanced/jenkins#pipelines" >}}) for all the details on this result object.
