...
![The agent CPU and GC overview table](/images/releasenotes/agents-gc-and-cpu-information-small.jpg)
*The agent CPU and GC overview table*

![The CPU usage chart for an agent](/images/releasenotes/agent-cpu-usage-chart-small.jpg)
...
![A screenshot of the new report layout](/images/releasenotes/new-test-report-design-small.jpg)
...
![The new result browser interface](/images/releasenotes/new-result-browser-overview-small.jpg)
...
![Events on the console output](/images/releasenotes/events-on-console-small.jpg)
...
![The new concurrent user chart](/images/releasenotes/new-concurrent-user-chart-in-transaction-small.jpg)
...
![Time formatting in reports](/images/releasenotes/new-time-format-settings-small.jpg)
