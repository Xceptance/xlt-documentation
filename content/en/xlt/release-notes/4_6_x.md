...
See the [User Manual]({{< relref "report-configuration#adjusting-the-charting" >}}) for more
information.
...
See the [User Manual]({{< relref "report-configuration" >}}) for more
...
information about installing and using this plug-in see the [Jenkins Plug-in]({{< relref "xlt/advanced/jenkins" >}}) page.
{{% /note %}}
