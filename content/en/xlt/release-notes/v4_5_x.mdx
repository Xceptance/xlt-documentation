...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/107).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/106).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/105).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/102).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/100).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/99).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/97).
...
for execution was always `undefined`. See [Firefox 35: Passing arguments to executeScript isn't working](https://code.google.com/p/selenium/issues/detail?id=8390).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/93).
...
yet. See [Firefox 35: Passing arguments to executeScript isn't working](https://code.google.com/p/selenium/issues/detail?id=8390).
...
changes and view the current roadmap in the [XLT Information Center](https://lab.xceptance.de/versions/75).
...
![Load Testing Dashboard](/images/releasenotes/xlt450/realtime-reporting.png)
...
![](/images/releasenotes/xlt450/new_chart.png)}}
New Chart
:::
