...
Almost all other third-party libraries have been updated as well, including Selenium. Since the new Selenium does no longer support the "legacy mode" of `FirefoxDriver`, we had to remove that from XLT as well.
