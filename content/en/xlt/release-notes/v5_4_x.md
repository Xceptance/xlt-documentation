...
title: 5.4.x
date: 2021-04-23
description: "XLT now shows a progress bar on report generation, timer files are
  stored in compressed form, and a few issues were fixed.\n"
sidebar:
  label: 5.4.x
  order: 79
---
