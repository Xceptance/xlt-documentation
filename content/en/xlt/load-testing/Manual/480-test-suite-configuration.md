...
Please check the full [list of currently supported framework properties]({{< relref "/xlt/release-notes/4_8_x#scenario-specific-overrides-of-framework-properties" >}}) and their default value in the release notes.
