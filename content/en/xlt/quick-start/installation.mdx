---
title: Installation
description: "How to install XLT.\n"
sidebar:
  order: 10
---
...
- Java 21 or later (see [release notes](/xlt/release-notes/) for currently recommended version)
...
The XLT archive can be obtained from the [Xceptance website](https://www.xceptance.com/en/xlt/download.html) or from Maven Central (see [below](#maven)) which allows users of Maven and Gradle to conveniently integrate XLT and all of its dependencies into their build processes.
