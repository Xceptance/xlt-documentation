...
description: "The most simple test suite that directly works on the XLT API, aka
  the Basic Demo Test Suite.\n"
sidebar:
  order: 10
---
...
This suite targets our demo application, the **[Posters Shop](/xlt/quick-start/demo-application/)**, available on [GitHub](https://github.com/Xceptance/posters-demo-store) and included in the `samples` directory of the XLT distribution.
...
For a guided introduction, visit the [Quick Start](/xlt/quick-start/demo-test-suite/) section.
