...
description: "The XLT result browser provides valuable insights during
  development as well as during load test execution and evaluation.\n"
sidebar:
  order: 440
---
...
![Console output for local test run](/images/user-manual/localTest_console.png)
...
- Requests that return with status code 301 or 302 are redirects and will appear <span style={{ color: "grey" }}>grey</span>.
- Requests that return with status code 0, 400 or anything greater than 400 are errors and will appear <span style={{ color: "red" }}>red</span>.
- All other requests will appear <span style={{ color: "black" }}>black</span> unless the value of their content type meets one of the following conditions:
  - If the content type contains the string `javascript` or is equal to `application/json`, the request will appear <span style={{ color: "#7D28C0" }}>purple</span>.
  - If the content type starts with the string `image`, the request will appear <span style={{ color: "green" }}>green</span>.
  - If the content type is `text/css`, the request will appear <span style={{ color: "blue" }}>blue</span>.
...
![XLT Result Browser - Request Color Coding](/images/user-manual/result-browser_colorCoding.png)
...
![XLT Result Browser - Request Filters](/images/user-manual/result-browser_filter.png)
...
![XLT Result Browser - Request Details](/images/user-manual/result-browser_requestDetails.png)
...
![XLT Result Browser - Response Content](/images/user-manual/result-browser_response1_small.png)
...
![XLT Result Browser - Response Content, beautified](/images/user-manual/result-browser_response2_small.png)
*XLT Result Browser - Response Content, beautified*

- and by clicking _Highlight_, syntax highlighting will be added to the code.

![XLT Result Browser - Response Content, highlighted](/images/user-manual/result-browser_response3_small.png)
...
![XLT Result Browser - Inspect Element](/images/user-manual/result-browser_inspect.png)
...
![Value Log in the Result Browser](/images/user-manual/resultbrowser_value_log.png)
*Value Log in the Result Browser*

To learn how this feature may aid in error analysis and allows you to reconstruct and rerun a failed test case iteration without having to dig into log files, see [How to Add Debug Data to the Result Browser](/xlt/how-tos/debug-data-result-browser/).
...
![HAR Viewer](/images/releasenotes/4.13.0/har-viewer.png)
*HAR Viewer*
