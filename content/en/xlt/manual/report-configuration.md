...
To define your preferred default directory where test reports shall be stored (which is used when no [custom output directory]({{< relref "report-options#setting-a-custom-output-directory" >}}) is specified during report generation), set:
