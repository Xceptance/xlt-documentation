...
description: "XLT can control a real browser to solve more tricky performance
  test challenges.\n"
sidebar:
  order: 600
---
...
To run your XLT client performance test, just make sure you use the right web driver settings and enabled the client performance test cases you wrote, then you can just run a small performance test [as usual](/neodymium/framework/test-execution/) to measure and sample enough data (keep in mind a much shorter testing window might be sufficient in this case).
