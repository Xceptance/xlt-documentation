---
title: Test Suites
description: "XLT uses the concept of a test suite to make test projects more
  easily manageable.\n"
sidebar:
  order: 450
---
...
The directory of any [sample test suite](/xlt/manual/test-suites/), and also of your own test suite, should look similar to this:
...
* **config** contains all [test settings](/xlt/manual/test-suite-configuration/}
