...
To run your XLT client performance test, just make sure you use the right web driver settings and enabled the client performance test cases you wrote, then you can just run a small performance test [as usual]({{< relref "test-execution" >}}) to measure and sample enough data (keep in mind a much shorter testing window might be sufficient in this case).

### Evaluating the Client Performance Test

After you executed and finished your client performance load test, you can now [create the test report]({{< relref "test-evaluation" >}}
