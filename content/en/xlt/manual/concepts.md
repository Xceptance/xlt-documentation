...
tags: ["concepts", "architecture", "transaction", "action", "request"]
...
XLT automatically validates HTTP response codes. By default, generic error handling considers 4xx and 5xx status codes as errors, while 2xx and 3xx codes are treated as successful.
{{% /note %}}
