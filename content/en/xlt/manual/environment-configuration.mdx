...
description: "All properties for controlling the load and performance test environment.\n"
sidebar:
  order: 490
---
...
For detailed architecture, configuration steps, and properties, see the dedicated [Private Machine Mode](/xlt/manual/private-machines/) guide.
