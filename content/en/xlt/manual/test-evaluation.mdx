...
description: "How to collect test results and evaluate intermediate results.\n"
sidebar:
  order: 320
---
...
:::note
To learn more about the different report types XLT can create, follow up [here](/xlt/manual/reports/). For more information on how to customize your reports, please have a look at the [Report Options](/xlt/manual/report-options/).
:::
...
![Load Profile](/images/quickstart/load-profile.png)
*Load Profile*
...
![Concurrent Users Chart](/images/quickstart/concurrent-users.png)
...
![Requests Per Second Chart](/images/quickstart/RequestsPerSecond-2.png)
*Requests Per Second Chart*

![Request Runtime Chart](/images/quickstart/RequestRuntime.png)
...
![Transaction Errors Chart](/images/quickstart/TransactionErrors.png)
...
![The network statistics section](/images/user-manual/network_statistics_small.png)
...
![Example for an HTTP response code chart in the report's network section](/images/user-manual/report_responsecode-chart.png)
...
The *Custom Timers* page includes all [timers](/xlt/advanced/custom-data/#custom-timers) that have been placed individually within the test code. The chart and data description is identical to the *Actions* section.

### Custom Data

The *Custom Data* page contains two sections. In case [custom samplers](/xlt/advanced/custom-data/#custom-values) have been run during the test, or if your test scenarios are instrumented to log custom values, the collected data is shown in the *Custom Values* section. If the test scripts have also been collecting [custom data logs](/xlt/advanced/custom-data/#custom-data-logs), they will be available for download in the *Custom Data Logs* section.

### Web Vitals

If the load test was run as an [automated client performance test](/xlt/manual/client-performance/#measuring-client-performance-with-xlt) with Chromium browsers, this page displays the scores for all supported Web Vitals for each action in your scenarios. The score value is the 75th percentile of all observations and is rated as *good*, *needs improvement*, and *poor* using the colors green, yellow, and red according to Web Vital-specific thresholds.

### External Data

All [external data](/xlt/advanced/custom-data/#external-data) gathered by other tools during the test run is shown here according to the configuration.
...
![Agents](/images/quickstart/agent-CpuUsage.png)
*Agents*
...
![Text Filters](/images/releasenotes/4.6.0/report_filters.png)
*Text Filters*
