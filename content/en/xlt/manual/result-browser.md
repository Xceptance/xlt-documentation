...
If you have saved the page output to disk and want links from the error entries in the load test report to the corresponding result browsers in the results directory in your [report]({{< relref "test-evaluation" >}}
...
- _Request/Response Information_
  - General Information
...
The HAR viewer can be opened either by clicking the _View as HAR_ link
