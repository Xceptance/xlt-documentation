...
description: "A comprehensive reference of all XLT configuration properties for
  load testing, report generation, and development.\n"
sidebar:
  order: 1000
---
...
Colorize request table cells based on performance thresholds. For a detailed guide and examples, see [Report Colorization](/xlt/manual/report-configuration/#report-colorization) and the [4.10.x Release Notes](/xlt/release-notes/v4_10_x/#colored-request-table-cells).
