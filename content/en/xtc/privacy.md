...
In case you chose to use an [external login provider](/xtc/basics/user-accounts/#external-login-providers-sso) for authentication you will exchange data with your login provider (Google or Microsoft).
