...
* Currently available XLT execution environments:
    * XLT 6.x → [6.2.2](/xlt/release-notes/v6_2_x/)


## Monitoring

* Monitoring alerts may now be sent not only as email or text message, but also via Slack. Configure the target Slack channel(s) as new recipients in the Scenario Defaults and en/disable them on scenario level as needed. Note that for Slack alerts to work, you’ll first need to set up Slack for your monitoring project [as outlined here](/xtc/integrations/slack/).
