...
* Currently available XLT execution environments
    * XLT 5.x → [5.7.1](/xlt/release-notes/v5_7_x/) (deprecated, will be **removed on May 3, 2022**)
    * XLT 6.x → [6.1.0](/xlt/release-notes/v6_1_x/) (recommended)
...
A [new section](/xtc/basics/organizations/#mandatory-login-requirements) in the XTC documentation describes **how to configure optional access requirements**, such as using 2FA or an external SSO account, for your organization.
