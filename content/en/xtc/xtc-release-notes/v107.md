...
* Currently available XLT execution environments:
    * XLT 8.x → [8.6.0](/xlt/release-notes/v8_6_x/) (deprecated, will be **retired in November, 2025**)
    * XLT 9.x → [9.2.0](/xlt/release-notes/v9_2_x/) (**[migration needed](/xlt/release-notes/v9_0_x/#test-suite-migration)**)
