...
Secret properties behave the same as regular properties (see [XTC 37](/xtc/xtc-release-notes/v37/), for more details). However, their values will be masked with ******, both in the load test report and in the result data set.
...
- Load tests will now be executed with [XLT 5.6.0](/xlt/release-notes/v5_6_x/).
