...
* XLT 9.x → [9.2.2](/xlt/release-notes/v9_2_x/) (recommended)
* XLT 10.x → [10.0.0-beta-4](/xlt/release-notes/v10_0_x/)
...
Refer to the [XTC v115 Release Notes](/xtc/xtc-release-notes/v115/#new-feature-push-notifications) for details on how users can set up and configure push notifications for their account.

Follow these steps to migrate your notification lists:

1. **Verify user setup:** Ensure all target users have enabled push notifications in their XTC user account and verified that notifications are working correctly.
2. **Update project notification lists:** Review all notification lists in your monitoring projects:
