...
* Currently available XLT execution environments:
    ...
    * XLT 8.x → [8.0.0](/xlt/release-notes/v8_0_x/) (recommended, but **[migration needed](/xlt/release-notes/v8_0_x/#test-suite-migration)**)
