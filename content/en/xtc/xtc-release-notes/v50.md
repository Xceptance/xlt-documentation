...
* The way the Slack integration is configured has changed a little. XTC now uses the recommended OAUth flow to create Slack API tokens on your behalf. For more information on the Slack integration setup, see the [respective chapter](/xtc/integrations/slack/) in the XTC documentation.
...
* Currently available XLT execution environments:
    * XLT 6.x → [6.2.1](/xlt/release-notes/v6_2_x/)
