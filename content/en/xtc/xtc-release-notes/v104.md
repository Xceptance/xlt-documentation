...
* When setting the load factor in the *Load Profile* section of a load test, you can now enter a [relative load function](/xlt/manual/load-configuration/#relative-load-function-definition) as an alternative to static values or absolute load functions.
...
* Currently available XLT execution environments:
    ...
    * XLT 9.x → [9.1.1](/xlt/release-notes/v9_1_x/) (**[migration needed](/xlt/release-notes/v9_0_x/#test-suite-migration)**)
