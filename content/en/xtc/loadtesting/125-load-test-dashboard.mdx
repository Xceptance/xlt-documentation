---
title: Dashboard
description: "The Dashboard page of loadtest projects and its use.\n"
sidebar:
  order: 125
---
...
![The dashboard of a load test project.](/images/xtc/loadtest_dashboard.png)
...
:::info[Role Required]
To pin or unpin artifacts, your account must at least have the role of a [tester](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::