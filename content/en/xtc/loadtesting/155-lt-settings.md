...
The machines to be used can be selected from public cloud machines (_Amazon Cloud Machines_, _Google Cloud Machines_, or _Hetzner Cloud Machines_), custom machines, or your own [private machines]({{< relref "156-private-machines" >}}) (or you can use a combination of these).
...
For details on how to set up and register your own private machine infrastructure, see [Private Machines]({{< relref "156-private-machines" >}}).
