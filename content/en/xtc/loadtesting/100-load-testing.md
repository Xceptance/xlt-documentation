...
XTC helps you to streamline your load testing work by providing helpful features it puts on top of what's already included in [XLT]({{< relref "xlt/" >}}):
...
To run a load test in XTC, we assume you have an [XLT Test Suite]({{< relref "test-development" >}}) available in the [repository]({{< relref "../basics/060-project-configuration/#repository" >}}) of your choice. (For more information on what to prepare and think about before load testing, see our recommendations for a load testing [workflow]({{< relref "workflow" >}}).)

## Workflow

**Running a load test with XTC** usually consists of the following steps which you can also learn more about in the [load testing documentation]({{< relref "100-load-testing" >}}):
