---
title: Code Archives
description: "Using uploaded ZIP archives instead of Git repositories to provide
  load test suites.\n"
sidebar:
  order: 122
---
...
:::info[Role Required]
To view code archives, your account must at least have the role of a [tester](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::
:::info[Role Required]
To manage code archives, your account must at least have the role of a [test manager](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::
