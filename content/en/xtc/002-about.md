...
XTC (**X**ceptance **T**est **C**enter) is the working title of a SaaS offering to deliver XLT as a service. It will increase efficiency, lower the time to test, and enables you to do all things you might have been doing [manually before]({{< relref "/load-testing/manual/310-test-execution" >}}). It is still in development and continuously improved, but you can already use it. It allows you to:
...
XTC load and monitoring service are based fully [XLT]({{< relref "/about-xlt/" >}}), hence everything you know about  [Load Testing]({{< relref "/load-testing/" >}}) is valid. [Test development]({{< relref "/load-testing/manual/060-test-development" >}}) still takes place in your IDE and test suites live in your preferred GIT repo. 
