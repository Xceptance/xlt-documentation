---
title: User Accounts
description: "How to set up user accounts, 2FA and SSO in XTC.\n"
sidebar:
  order: 40
---
...
To use Xceptance Test Center, you need a user account. You can easily sign up on [https://xtc.xceptance.com/](https://xtc.xceptance.com/). You will be prompted to enter your name, mail address and password. Alternatively, [you can sign up using your Google or Microsoft account](#sign-up-using-an-external-provider).
...
In **Profile** you may update your profile information such as your first and last name, your phone number (which may be useful for receiving [monitoring notifications](/xtc/monitoring/scenarios/#notifications)), and you can upload an avatar/profile picture. This section also allows you to [pause notifications](#pausing-notifications).
...
In addition to securing your account with a regular password, you may set up _time-based one-time passwords (TOTP)_ as a [second factor (2FA)](#two-factor-authentication-2fa) here.
...
Organization admins may impose **mandatory login requirements** on users of their organization. They may require users to be authenticated using specific login providers or 2FA. Read more about this [here](/xtc/basics/organizations/#mandatory-login-requirements).
...
* If you need to access your account immediately, an [Organization Administrator](/xtc/basics/organizations/#locking-members-of-an-organization) can unlock your account manually from the organization's members list.

## Notifications

XTC users will get notified by email whenever their membership in a project or organization has changed:

* when they have been added to or removed from an [org](/xtc/basics/organizations/#adding-members-to-an-organization) or [project](/xtc/basics/projects/#adding-and-removing-project-members),
* when their [org](/xtc/basics/organizations/#user-roles-within-an-organization) or [project](/xtc/basics/projects/#user-roles-within-a-project) role has been changed, or
* when they have actively been [locked or unlocked](/xtc/basics/organizations/#locking-members-of-an-organization) by an org admin.
...
* Emails and text messages about [monitoring alerts](/xtc/monitoring/scenarios/#notifications)).
...
![](/images/xtc/notifications_paused.png)
**
...
* If your email address has been added as a [custom subscriber](/xtc/monitoring/monitoring-configuration/#defining-a-notification-list). Change it to an [XTC user subscriber](/xtc/monitoring/monitoring-configuration/#defining-a-notification-list).
...
:::note
Note that if you are using an [external login provider](#external-login-providers-sso) to log in, XLT will not ask you for a TOTP as in this case 2FA is managed in the settings of your external account.
:::
...
![Registration form with buttons for external login providers](/images/xtc/registration-form.png)
...
![Registration details form pre-filled with data from the login provider](/images/xtc/registration-form-return.png)
...
3. Select your preferred login provider via the appropriate button.
   ...
   ![UI to connect existing accounts to external providers. The user in the example is already connected to a Google account. Therefore the Google button is disabled.](/images/xtc/switch-to-external-login.png)
...
![Login form with buttons for external login providers](/images/xtc/login-form.png)
