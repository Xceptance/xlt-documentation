---
title: Projects
description: "Projects in XTC, how they work, how to create them and change
  project members.\n"
sidebar:
  order: 50
---
...
Projects can either be of type [monitoring](/xtc/monitoring) or [load test](/xtc/loadtesting). They have a different set of properties depending on their nature.
...
![A monitoring project on the dashboard of the _Xceptance_ organization.](/images/xtc/organizations_monitoringProject.png)
*A monitoring project on the dashboard of the _Xceptance_ organization.*

The project menu on the left side will look a bit different depending on whether you are currently viewing a [load test project](/xtc/loadtesting) or a [monitoring project](/xtc/monitoring):

![The menu of a monitoring project (left) and a load testing project (right).](/images/xtc/project_menus.png)
*The menu of a monitoring project (left) and a load testing project (right).*

Every project can be [assigned its own set of members](#adding-and-removing-project-members) and [configured](/xtc/basics/project-configuration/) independently of any other project in the organization.

## Creating a New Project

:::info[Role Required]
To create new projects, your account must have the role of an [organization administrator](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::
...
![A list of projects in an organization, as seen by the organization administrator.](/images/xtc/ui_projectsInOrg.png)
*A list of projects in an organization, as seen by the organization administrator.*

By clicking the `+` button top right, you will see a popup menu to add either a [Monitoring Project](/xtc/monitoring) or a [Load Testing Project](/xtc/loadtesting). The project nature can not be changed once the project was created.

![Adding a new project](/images/xtc/ui_newProject.png)
...
![Footer displaying the user's role in the project.](/images/xtc/ui_projectRole.png)
...
By default, you can only assign users who are already [members of your organization](/xtc/basics/organizations/#adding-members-to-an-organization). If desired, you can [invite users](#inviting-users-to-join-xtc) who either don't have an XTC account yet or are not part of your organization.
...
Instead of adding single users to a new project, you may want to add an exisiting **[User Group](/xtc/basics/organizations/#user-groups)** of your organization.
...
As a project admin you may invite users who do not have an XTC account or are not part of the project's organization yet to join your project in XTC (if this feature is [enabled](#organization-configuration) for the organization). Simply [add these users to your project](#adding-and-removing-project-members) as usual, but make sure you activate the _Invite Users_ toggle.
...
:::info[Role Required]
To use this feature, your account must have the role of an [organization administrator](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::

Projects are typically managed by [project administrators](#user-roles-within-a-project). If no project administrator is currently available, the organization administrator can add new users as project administrators to the project or grant the _Project Administrator_ role to existing project members.
...
* A [project administrator](#user-roles-within-a-project) may toggle the state of the project between active and inactive. In the project, go to _Configuration > General > Project State_ and edit the state as needed.
* An [organization administrator](/xtc/basics/organizations/#user-roles-within-an-organization) may set all three project states. In the organization, go to _Projects_, click the _Change State_ menu item in the context menu of the project in question, and set the state as needed.
...
:::info[Role Required]
To delete a project, your account must have the role of an [organization administrator](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::
...
Please note that deleting is only possible for [active or inactive](#project-states) projects on the organization page. [Archived](#project-states) projects can not be deleted.
...
:::info[Role Required]
To view the documentation page, your account must at least have the role of a [reviewer](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::

:::info[Role Required]
To edit the documentation, your account must at least have the role of a [test manager](/xtc/basics/projects/#user-roles-within-a-project) within the project.
:::
