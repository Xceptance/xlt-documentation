...
description: "The basic structure of XTC. All about users, organizations and projects.\n"
sidebar:
  order: 30
---
...
The basic idea of XTC is: [user accounts](/xtc/basics/user-accounts/) can run tests organized in [projects](/xtc/basics/projects/) of different project natures for [organizations](/xtc/basics/organizations/).

![XTC User Accounts as Members of Orgs which Contain Projects that Run Tests](/images/xtc/xtc_basic_structure.svg)
*XTC User Accounts as Members of Orgs which Contain Projects that Run Tests*

To use Xceptance Test Center, you need an account. You can easily sign up on [https://xtc.xceptance.com/](https://xtc.xceptance.com/). XTC allows you to either select a password for your account, or use an external login provider (Google or Microsoft) for SSO. For more information, see [user accounts](/xtc/basics/user-accounts/).

## Home Dashboard

When you log in to XTC you will first see a dashboard page.

![The XTC home dashboard.](/images/xtc/home_dashboard.png)
...
![The XTC top menu allows you to select organization and project directly.](/images/xtc/topmenu.png)
...
![Clicking the link in the sidebar will take you back to a project's organization.](/images/xtc/ui_backToOrg.png)
