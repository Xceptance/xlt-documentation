...
- Install a recent release of the Hugo "extended" version (we recommend version 0.151.0 or later). 
...
- [Install the current Node environment](https://docs.npmjs.com/downloading-and-installing-node-js-and-npm) (version >= 22.x).
